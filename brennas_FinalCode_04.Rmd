...
#FA: Overall your code looks great!, I only included some comments for the legend to show up (line 302-311) - Althought I am not sure if this is correct
I couldnt get the legend to work :(
...
g <- g + scale_colour_manual(name="Intervals", values = c("Confidence" = "blue", "Prediction" = "red") )

#g <- g + scale_fill_discrete(name="Interval",
#                         breaks=c("blue", "red"),
...
#FA: From line 286 to 297 I used the next code, I am not sure if it is the correct way to make the legend the show up, and I think it works on the log equation too.
#FA: g <- g + geom_line(aes(x = x, y = CIfit, colour = "black"))
#FA: g <- g + geom_line(aes(x = x, y = CIlwr, colour = "Confidence Interval"))
#FA: g <- g + geom_line(aes(x = x, y = CIupr, colour = "Confidence Interval"))
#FA: g <- g + geom_line(data = pf, aes(x = x, y = PIlwr, colour = "Prediction Interval"))
#FA: g <- g + geom_line(data = pf, aes(x = x, y = PIupr, colour = "Prediction Interval"))
#FA: g <- g + scale_colour_manual("", values = c("black"="black", "Confidence Interval"="blue", "Prediction Interval"="red"))
#FA: g <- g + theme (
#FA: legend.position = c(0.95, 0.2),
#FA: legend.justification = c("right"))
```{r}
#log equation
